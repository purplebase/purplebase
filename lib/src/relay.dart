...
// class RelayMessageNotifier extends RelayNotifier {
//   WebSocketPool? pool;
...
//   final _requests = <RequestFilter>{};
//   final _resultsOnEose = <(String, String), List<Map<String, dynamic>>>{};

//   RelayMessageNotifier(Set<String> relayUrls) : super(RelayIdle()) {
...
//               // );
//               state = RelayData([...?state.models], // TODO: , eventFrom(map)
//                   subscriptionId: subscriptionId);
//             }
//             break;
//           case 'NOTICE':
...
//               state = RelayError([...?state.models],
//                   message: 'error', subscriptionId: subscriptionId);
//             }
//           case 'CLOSED':
//             // state = ErrorRelayMessage(
//             //     relayUrl: relayUrl,
...
//             //     error: rest.join(', '));
//             state = RelayError([...?state.models],
//                 message: rest.join(', '), subscriptionId: subscriptionId);
//           case 'EOSE':
//             if (_resultsOnEose.containsKey((relayUrl, subscriptionId))) {
...
//         state = RelayError([...?state.models],
//             message: err.toString(), subscriptionId: subscriptionId);
//         _sub?.cancel();
//         _streamSub?.cancel();
...
//   RelayState get relayMessage => super.state;
...
//   @override
//   void send(RequestFilter req, [Object? key]) {
//     _requests.add(req);
